...
using WebApplicationOrders.Models;
using WebApplicationOrders.ServiceReference;

namespace WebApplicationOrders.Business
{
    public class SalesBU
    {
        ...
        public List<GetOrders_Result> getCustomerOrdersService(int id)
        {
            using (client = new DataServiceClient())
            {
                List<GetOrders_Result> orders;
                orders = client.getCustomerOrders(id).ToList().Select(o => new GetOrders_Result{
                    CustomerName = o.CustomerName,
                    ProductName = o.CustomerName,
                    Date = o.Date,
                    Total = o.Total,
        ...
        {
            List<SelectListItem> list = new List<Models.SelectListItem>();
            list.Add(empty());
            return list;
        }
